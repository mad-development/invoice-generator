...
func (i *Invoice) GeneratePDF() {
	...
	pdf.CellFormat(40, 10, fmt.Sprintf("Address: %s", i.originAddress), "0", 0, "", false, 0, "")
	pdf.Ln(20)
...
func main() {
	...
	if *day == 0 || *month == 0 || *year == 0 || *value == 0.0 || *client == "" || *invoiceID == "" || *services == "" || *originName == "" || *originAddress == "" {
